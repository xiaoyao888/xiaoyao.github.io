...
var loadShareTip = function(){
        var isShareTip = localStorage.getItem("isShareTip");
        if(isShareTip==null){
            $("#friendTip").modal("show");
                
        }else{
            $("#friendTip").modal("hide");
        }
}
$("#cancelShareNoTip").click(function(){
        localStorage.setItem("isShareTip","false");
        $("#friendTip").modal("hide");
